...
description = "Printrbot";
vendor = "Printerbot";
vendorUrl = "https://github.com/schneik80/ACME-Printrbot-F360Post";
legal = "Copyright (C) ACMECADCAM";
certificationLevel = 2;
minimumRevision = 45633;

longDescription = "Simple post to export toolpath for Printrbot Machines in gcode format";
...
var printerLimits = {
  ...
  z: {min: 0, max: 150.0} //Defines the z bed size
};
